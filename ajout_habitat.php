...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "INSERT INTO habitats (nom_hab, typeclimat, description, zonezoo) 
            VALUES (:nom_hab, :typeclimat, :description, :zonezoo)";
...
<body class="bg-gray-100 min-h-screen p-6">
    ...
    <div class="max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold mb-6">Ajouter un habitat</h1>

        <form method="POST" class="bg-white rounded-lg shadow p-6">
            
            <div class="mb-4">
                <label class="block font-semibold mb-2">Nom de l'habitat</label>
                <input type="text" name="nom_hab" required class="w-full border rounded px-3 py-2">
            </div>

            <div class="mb-4">
                <label class="block font-semibold mb-2">Type de climat</label>
                <input type="text" name="typeclimat" required class="w-full border rounded px-3 py-2">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="zonezoo" required class="w-full border rounded px-3 py-2">
            </div>
